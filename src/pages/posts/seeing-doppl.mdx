...
## Conclusion
Well there we go, another post on the Doppler effect. I hope you enjoyed the animations as much as I enjoyed making them. As usual the code that I used to create these animations can be found on [my GitHub here](https://github.com/James-Rhodes/seeing-doppl). Thanks so much for your time! Fingers crossed it's not another year before my next post :)
